...
class ProductoController extends Controller
{
    ...
    public function getShow($id){
        return view("productos.show", array("producto" => self::$arrayProductos[$id]));
    }
    ...
    public function getEdit($id){
        return view("productos.edit", array("producto" => self::$arrayProductos[$id]));
    }

    static $arrayProductos = array(
